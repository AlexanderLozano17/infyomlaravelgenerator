...
class CarDriveAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse($carDrives->toArray(), 'Car Drives retrieved successfully');
    }
    ...
    public function store(CreateCarDriveAPIRequest $request)
    {
        ...
        return $this->sendResponse($carDrive->toArray(), 'Car Drive saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse($carDrive->toArray(), 'Car Drive retrieved successfully');
    }
    ...
    public function update($id, UpdateCarDriveAPIRequest $request)
    {
        ...
        return $this->sendResponse($carDrive->toArray(), 'CarDrive updated successfully');
    }
